...
<body style="overflow:hidden ">
							...
							background="image/top_2.jpg"><table width="100%" border="0"
								...
								<tr>
									...
									<td width="27%" align="right"><table width="75%"
											...
											<tr>
												<td width="128" height="24" align="right"
													background="image/top.jpg"><img src="image/bian.gif"
													width="128" height="24" border="0" usemap="#Map"></td>
											</tr>
										</table></td>
								</tr>
							</table></TD>
			...
			<td height="29" background="image/top_m.gif">
				<table width="100%" border="0" cellpadding="0" cellspacing="0">
					<tr>
						...
						<td class="top1" onClick="goto(1);" id="ttd1"><a
							href="jsp/system/index.jsp" target="midFrame">系统管理</a>
						</td>
						<td><img src="image/top_line.gif" width="2" height="29">
						</td>
						<td class="top1" onClick="goto(8);" id="ttd8"><a
							href="jsp/stock/index.jsp" target="midFrame">库存管理</a>
						</td>
						<td><img src="image/top_line.gif" width="2" height="29">
						</td>
						<td class="top1" onClick="goto(10);" id="ttd10"><a
							href="jsp/common/index.jsp" target="midFrame">辅助管理</a>
						</td>
	...
	<map name="Map">
		...
		<area shape="rect" coords="68,3,127,25" href="jsp/index/login.jsp"
			target="_parent">
	</map>
</body>
</html>