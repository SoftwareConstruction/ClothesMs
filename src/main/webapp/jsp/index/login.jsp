...
<BODY BACKGROUND="image/bg.gif">
			...
			<td width="100%" height="32"><TABLE WIDTH=100% BORDER=0
					...
					<TR>
						...
						<TD width="90%" align="right" valign="bottom"
							background="image/top_2.jpg"><table width="100%"
	...
	<FORM NAME="idFrmMain" METHOD="POST" ACTION="jsp/index/Main.jsp">
				...
				<td align="center" valign="middle">
					<table width="300" border="0" cellspacing="0" cellpadding="0">
						<tr>
							...
							<td>&nbsp;密码:<input name="psword" type="password" size="10">
							</td>

							<td width="42"><input name="imageField" type="submit"
								value="登录" alt="登录" width="42" height="32" border="0">
							</td>
						</tr>
					</table>
				</td>
