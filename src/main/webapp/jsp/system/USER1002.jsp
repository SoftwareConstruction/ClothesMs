		...
		<table border="0" width="100%" id="table1" cellspacing="1"
			...
			<tr>
				...
				<td class="textbar01" width="85%" colspan="1"><input
					name="name" value="BSDDRP" size="20">
				</td>
			</tr>
			<tr>
				<td class="textbar81" width="15%" colspan="1">用户姓名</td>
				<td class="textbar01" width="85%" colspan="1"><input
					name="name" value="张三" size="20">
				</td>
			</tr>
			<tr>
				<td class="textbar81" width="15%" colspan="1">用户密码</td>
				<td class="textbar01" width="85%" colspan="1"><input
					type="password" name="leixing" value="123123" size="21">
				</td>
			</tr>
			<tr>
				<td class="textbar81" width="15%" colspan="1">用户简介</td>
				<td class="textbar01" width="85%" colspan="1"><textarea
						name="describe" style="width:352px">男，东北人士</textarea></td>
			</tr>
